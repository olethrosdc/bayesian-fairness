...
%% Calculate synthetic data result for a fixed sampling policy
function [PU, PF, PV] = ConvergenceEvaluationFixedPolicy(A=2, X=8, Y=2, Z=2, n_models=8, K=5, n_iter=10000, horizon=100)
